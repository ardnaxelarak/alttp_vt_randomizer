...
return [
    ...
    'weapons' => [
        ...
        'options' => [
            ...
            'vanilla' => 'Vanilla',
            'swordless' => 'Swordless',
            'swordless_b' => 'Swordless w/ Items on B',
            'bombs' => 'Bomb-Only',
            'assured_bombs' => 'Bomb-Only (Starting Bombs)',
            'byrna' => 'Byrna Mode',
            'assured_byrna' => 'Byrna Mode (Starting Cane)',
            'somaria' => 'Somaria Mode',
            'assured_somaria' => 'Somaria Mode (Starting Cane)',
            'cane' => 'Canes Mode',
            'pseudo' => 'Pseudo-Swords',
            'assured_pseudo' => 'Assured Pseudo-Swords',
            'bees' => 'Bee Mode',
            'bugnet' => 'Bug Net Mode',
            'assured_bugnet' => 'Bug Net Mode (Starting Bug Net)',
        ],
