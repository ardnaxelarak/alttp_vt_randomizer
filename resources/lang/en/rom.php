...
return [
    ...
    'info' => [
        ...
        'dungeon_items' => __('randomizer.dungeon_items.title'),
        ...
        'pottery' => __('randomizer.pottery_shuffle.title'),
        'enemy_shuffle' => __('randomizer.enemy_shuffle.title'),
        'boss_shuffle' => __('randomizer.boss_shuffle.title'),
