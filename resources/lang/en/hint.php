...
return [
    "item" => [
        ...
        "L1Bombs" => "Basic Bombs",
        "L2Bombs" => "Decent Bombs",
        "L3Bombs" => "Good Bombs",
        "L4Bombs" => "Fancy Bombs",
        "L5Bombs" => "Fancy Bombs",
        "ProgressiveBombs" => "Better Bombs",
        "L1Cane" => "A Basic Cane",
        "L2Cane" => "A Decent Cane",
        "L3Cane" => "A Good Cane",
        "L4Cane" => "A Fancy Cane",
        "L5Cane" => "A Fancy Cane",
    ...
    "location" => [
        "Agahnim 2" => "Agahnim 2",
        "Agahnim" => "Agahnim",
        "Aginah's Cave" => ["is with a hermit", "requires bombos"],
        ...
        "Blind's Hideout - Top" => ["is in Blind's Hideout", "requires bombos"],
        "Bombos Tablet" => ["is on a Tablet", "requires bombos"],
        "Bottle Merchant" => ["can be bought", "held by someone friendly"],
        "Brewery" => ["is in the dark village", "requires bombos"],
        ...
        "Checkerboard Cave" => ["is under a rock in the desert", "requires bombos"],
        "Chest Game" => "is in the dark village",
        "Chicken House" => ["is with the Chickens", "requires bombos"],
        ...
        "Desert Palace - Torch" => ["is in Desert Palace", "is in plain sight", "requires bombos"],
        ...
        "Ether Tablet" => ["is on a Tablet", "requires bombos"],
        "Floating Island" => ["is on Floating Island", "is in plain sight"],
        "Floodgate Chest" => "is near a water switch",
        "Flute Spot" => ["can be dug up", "requires bombos"],
        "Ganon" => "Ganon",
        "Ganon's Tower - Big Chest" => "is in Ganon's Tower",
        "Ganon's Tower - Big Key Chest" => ["is in Ganon's Tower", "requires bombos"],
        "Ganon's Tower - Big Key Room - Left" => ["is in Ganon's Tower", "requires bombos"],
        "Ganon's Tower - Big Key Room - Right" => ["is in Ganon's Tower", "requires bombos"],
        "Ganon's Tower - Bob's Chest" => "is in Ganon's Tower",
        "Ganon's Tower - Bob's Torch" => ["is in Ganon's Tower", "is in plain sight", "requires bombos"],
        "Ganon's Tower - Compass Room - Bottom Left" => ["is in Ganon's Tower", "requires bombos"],
        "Ganon's Tower - Compass Room - Bottom Right" => ["is in Ganon's Tower", "requires bombos"],
        "Ganon's Tower - Compass Room - Top Left" => ["is in Ganon's Tower", "requires bombos"],
        "Ganon's Tower - Compass Room - Top Right" => ["is in Ganon's Tower", "requires bombos"],
        "Ganon's Tower - DMs Room - Bottom Left" => ["is in Ganon's Tower", "requires bombos", "requires bombos"],
        "Ganon's Tower - DMs Room - Bottom Right" => ["is in Ganon's Tower", "requires bombos", "requires bombos"],
        "Ganon's Tower - DMs Room - Top Left" => ["is in Ganon's Tower", "requires bombos", "requires bombos"],
        "Ganon's Tower - DMs Room - Top Right" => ["is in Ganon's Tower", "requires bombos", "requires bombos"],
        "Ganon's Tower - Firesnake Room" => ["is in Ganon's Tower", "requires bombos", "requires bombos"],
        "Ganon's Tower - Hope Room - Left" => "is in Ganon's Tower",
        "Ganon's Tower - Hope Room - Right" => "is in Ganon's Tower",
        "Ganon's Tower - Map Chest" => ["is in Ganon's Tower", "requires bombos"],
        "Ganon's Tower - Mini Helmasaur Room - Left" => "is in Ganon's Tower",
        "Ganon's Tower - Mini Helmasaur Room - Right" => "is in Ganon's Tower",
        "Ganon's Tower - Moldorm Chest" => ["is in Ganon's Tower", "requires bombos"],
        "Ganon's Tower - Pre-Moldorm Chest" => "is in Ganon's Tower",
        "Ganon's Tower - Randomizer Room - Bottom Left" => ["is in Ganon's Tower", "requires bombos", "requires bombos", "requires bombos"],
        "Ganon's Tower - Randomizer Room - Bottom Right" => ["is in Ganon's Tower", "requires bombos", "requires bombos", "requires bombos"],
        "Ganon's Tower - Randomizer Room - Top Left" => ["is in Ganon's Tower", "requires bombos", "requires bombos", "requires bombos"],
        "Ganon's Tower - Randomizer Room - Top Right" => ["is in Ganon's Tower", "requires bombos", "requires bombos", "requires bombos"],
        "Ganon's Tower - Tile Room" => ["is in Ganon's Tower", "requires bombos"],
        "Graveyard Ledge" => ["is above the poes", "requires bombos"],
        "Hammer Pegs" => ["is under a stump", "requires bombos"],
        "Hobo" => ["is under a bridge", "held by someone friendly"],
        "Hookshot Cave - Bottom Left" => ["is in Hookshot Cave", "requires bombos", "requires bombos"],
        "Hookshot Cave - Bottom Right" => ["is in Hookshot Cave", "requires bombos"],
        "Hookshot Cave - Top Left" => ["is in Hookshot Cave", "requires bombos", "requires bombos"],
        "Hookshot Cave - Top Right" => ["is in Hookshot Cave", "requires bombos", "requires bombos"],
        "Hype Cave - Bottom" => ["is in the Hype cave", "requires bombos"],
        "Hype Cave - Middle Left" => ["is in the Hype cave", "requires bombos"],
        "Hype Cave - Middle Right" => ["is in the Hype cave", "requires bombos"],
        "Hype Cave - NPC" => ["is in the Hype cave", "requires bombos", "held by someone friendly"],
        "Hype Cave - Top" => ["is in the Hype cave", "requires bombos"],
        ...
        "Ice Palace - Big Chest" => ["is in Ice Palace", "requires bombos"],
        "Ice Palace - Big Key Chest" => ["is in Ice Palace", "requires bombos", "requires bombos", "requires bombos"],
        "Ice Palace - Compass Chest" => "is in Ice Palace",
        "Ice Palace - Freezor Chest" => ["is in Ice Palace", "requires bombos"],
        "Ice Palace - Iced T Room" => ["is in Ice Palace", "requires bombos"],
        "Ice Palace - Boss" => ["is in Ice Palace", "requires bombos", "is on a boss", "requires bombos", "requires bombos"],
        "Ice Palace - Map Chest" => ["is in Ice Palace", "requires bombos", "requires bombos", "requires bombos"],
        "Ice Palace - Prize" => "is in Ice Palace",
        "Ice Palace - Spike Room" => ["is in Ice Palace", "requires bombos"],
        "Ice Rod Cave" => ["is in a cold Cave", "requires bombos"],
        ...
        "Lumberjack Tree" => ["is in plain sight", "requires bombos"],
        ...
        "Mimic Cave" => ["is in Mimic Cave", "requires bombos"],
        "Mini Moldorm Cave - Far Left" => ["is in Mini Moldorm Cave", "requires bombos"],
        "Mini Moldorm Cave - Far Right" => ["is in Mini Moldorm Cave", "requires bombos"],
        "Mini Moldorm Cave - Left" => ["is in Mini Moldorm Cave", "requires bombos"],
        "Mini Moldorm Cave - NPC" => ["is in Mini Moldorm Cave", "requires bombos", "held by someone friendly"],
        "Mini Moldorm Cave - Right" => ["is in Mini Moldorm Cave", "requires bombos"],
        ...
        "Misery Mire - Boss" => ["is in Misery Mire", "requires bombos", "is on a boss"],
        ...
        "Palace of Darkness - Boss" => ["is in Palace of Darkness", "requires bombos", "requires bombos", "is on a boss"],
        ...
        "Paradox Cave Upper - Left" => ["is in Paradox Cave", "requires bombos"],
        "Paradox Cave Upper - Right" => ["is in Paradox Cave", "requires bombos"],
        "Pegasus Rocks" => ["is under some Rocks", "requires bombos"],
        "Potion Shop" => ["is with the witch", "requires bombos"],
        ...
        "Spike Cave" => ["is in the Spike Cave", "requires bombos", "requires bombos"],
        ...
        "Swamp Palace - Boss" => ["is in Swamp Palace", "requires bombos", "requires bombos", "is on a boss"],
        "Swamp Palace - Big Chest" => ["is in Swamp Palace", "is in the Big Chest Swamp Palace", "requires bombos"],
        "Swamp Palace - Big Key Chest" => ["is in Swamp Palace", "is in western wing of Swamp Palace", "requires bombos"],
        "Swamp Palace - Compass Chest" => ["is in Swamp Palace", "requires bombos"],
        "Swamp Palace - Entrance" => "is in Swamp Palace",
        "Swamp Palace - Flooded Room - Left" => ["is in Swamp Palace", "requires bombos", "requires bombos", "is under water"],
        "Swamp Palace - Flooded Room - Right" => ["is in Swamp Palace", "requires bombos", "requires bombos", "is under water"],
        "Swamp Palace - Map Chest" => ["is in Swamp Palace", "requires bombos"],
        "Swamp Palace - Prize" => "is in Swamp Palace",
        "Swamp Palace - Waterfall Room" => ["is in Swamp Palace", "requires bombos", "requires bombos"],
        "Swamp Palace - West Chest" => ["is in Swamp Palace", "is in western wing of Swamp Palace", "requires bombos"],
        "Thieves' Town - Ambush Chest" => "is in Thieves' Town",
        "Thieves' Town - Attic" => "is in Thieves' Town",
        "Thieves' Town - Big Chest" => ["is in Thieves' Town", "requires bombos"],
        ...
        "Tower of Hera - Big Key Chest" => ["is in Tower of Hera", "needs bombos in Tower of Hera"],
        ...
        "Turtle Rock - Compass Chest" => ["is in Turtle Rock", "requires bombos"],
        ...
        "Turtle Rock - Roller Room - Left" => ["is in Turtle Rock", "requires bombos"],
        "Turtle Rock - Roller Room - Right" => ["is in Turtle Rock", "requires bombos"],
        "Turtle Rock - Boss" => ["is in Turtle Rock", "requires bombos", "is on a boss"],
