...
{
    const BUILD_INFO = [
        'base' => ['BUILD' => '2022-09-18', 'HASH' => '144cf31de54e068bff2631a105158e83'],
        'overworld' => ['BUILD' => '2022-09-18', 'HASH' => '62443f8204c7a042ea3923212177003f'],
        'only_bombos' => ['BUILD' => '2022-09-28', 'HASH' => 'bee679d4db24ed094893f1cbda3bad41'],
    ];
    const SIZE = 2097152;
    ...
    public function setCaneOnlyMode(bool $blue, bool $red): self
    {
        ...
        if ($red) {
            $this->write(0x3B07C, pack('C*', 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
            $this->write(0x3B0A8, pack('C*', 0xEA, 0xEA));
            $this->write(0x3B0AE, pack('C*', 0x81));
        }
        ...
        $spritedata = [
            ...
            0xDC,  $cb, 0xDD,  $cb, 0xEC,  $cb, 0x17,  $cb,
            0xDC,  $cb, 0xDD,  $cb, 0xEC,  $cb, 0x18,  $cb,
            0xDC,  $cb, 0xDD,  $cb, 0xEC,  $cb, 0x19,  $cb,
            0xDC,  $cb, 0xDD,  $cb, 0xEC,  $cb, 0x1A,  $cb,
            0xDC,  $cb, 0xDD,  $cb, 0xEC,  $cb, 0x1B,  $cb,
            0xF5, 0x20, 0xF5, 0x20, 0xF5, 0x20, 0xF5, 0x20,
            0xDC,  $cb, 0xDD,  $cb, 0xEC,  $cb, 0x17,  $cb,
            0xDC,  $cb, 0xDD,  $cb, 0xEC,  $cb, 0x18,  $cb,
            0xDC,  $cb, 0xDD,  $cb, 0xEC,  $cb, 0x19,  $cb,
    ...
    public function setBeeMode(): self
    {
        ...
        // Trinexx side heads fix
        $this->write(0x18CE61, pack('C*', 0x00, 0x00));
        $this->write(0x18CE69, pack('C*', 0x00, 0x00));
