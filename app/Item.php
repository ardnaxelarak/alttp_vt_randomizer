...
class Item
{
    ...
    public static function all(World $world)
    {
        ...
        static::$items[$world->id] = new ItemCollection([
            ...
            new Item\Bomb('Bomb', [0x27], $world),
            new Item\Bomb('ThreeBombs', [0x28], $world),
            ...
            new Item\Bomb('TenBombs', [0x31], $world),
            ...
            new Item\SwordBomb('L1Bombs', [0xB1], $world),
            new Item\SwordBomb('L2Bombs', [0xB2], $world),
            new Item\SwordBomb('L3Bombs', [0xB3], $world),
            new Item\SwordBomb('L4Bombs', [0xB4], $world),
            new Item\SwordBomb('L5Bombs', [0xB5], $world),
            new Item\SwordBomb('ProgressiveBombs', [0xB6], $world),
            new Item\SwordCane('L1Cane', [0xB7], $world),
            new Item\SwordCane('L2Cane', [0xB8], $world),
            new Item\SwordCane('L3Cane', [0xB9], $world),
            new Item\SwordCane('L4Cane', [0xBA], $world),
            new Item\SwordCane('L5Cane', [0xBB], $world),
            new Item\SwordCane('ProgressiveCane', [0xBC], $world),
