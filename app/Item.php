...
class Item
{
    ...
    public static function all(World $world)
    {
        ...
        static::$items[$world->id] = new ItemCollection([
            ...
            new Item\SwordBomb('L2Bombs', [0xB1], $world),
            new Item\SwordBomb('L3Bombs', [0xB2], $world),
            new Item\SwordBomb('L4Bombs', [0xB3], $world),
            new Item\SwordBomb('L5Bombs', [0xB4], $world),
            new Item\SwordBomb('ProgressiveBombs', [0xB5], $world),
