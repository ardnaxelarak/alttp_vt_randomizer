    ...
    public static function prepMultiworld(array $request, bool $save = true)
    {
        ...
        for ($i = 1; $i <= $count; $i++) {
            ...
            $worlds[] = World::factory($i, Arr::get($request, "worlds.{$i}.world_state", 'standard'), [
                ...
                'bossItems' => Arr::get($request, "worlds.{$i}.boss_items", 'any'),
                ...
                'doors.type_mode' => Arr::get($request, "worlds.{$i}.door_type_mode", 'original'),
                'doors.trap_mode' => Arr::get($request, "worlds.{$i}.trap_door_mode", 'vanilla'),
                'doors.decoupled' => Arr::get($request, "worlds.{$i}.decouple_doors", 'off'),
                ...
                'overworld.whirlpoolShuffle' => Arr::get($request, "worlds.{$i}.ow_whirlpool_shuffle", 'vanilla'),
                ...
                'equipment.flute' => Arr::get($request, "worlds.{$i}.starting_flute", 'off'),
                'equipment.boots' => Arr::get($request, "worlds.{$i}.starting_boots", 'off'),
