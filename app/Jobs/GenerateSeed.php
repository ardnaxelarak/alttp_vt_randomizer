...
class GenerateSeed implements ShouldQueue
{
    ...
    public static function prepSeed(array $request, bool $save = true)
    {
        ...
        $world = World::factory(1, Arr::get($request, 'mode', 'standard'), [
            ...
            'bossItems' => Arr::get($request, 'boss_items', 'any'),
            ...
            'doors.type_mode' => Arr::get($request, 'doors.type_mode', 'original'),
            'doors.trap_mode' => Arr::get($request, 'doors.trap_mode', 'vanilla'),
            'doors.decoupled' => Arr::get($request, 'doors.decoupled', 'off'),
            ...
            'overworld.whirlpoolShuffle' => Arr::get($request, 'overworld.whirlpool_shuffle', 'vanilla'),
            ...
            'equipment.flute' => Arr::get($request, 'equipment.flute', 'off'),
            'equipment.boots' => Arr::get($request, 'equipment.boots', 'off'),
